    ...
    get sortButton() {
        ...
        return html`
            ...
            >
                ...
                >
                <sp-menu-item role="menuitem" id="authored" label="abc" value="${SORT_ORDER.authored}"
                    >${popularityText}</sp-menu-item
                >
                <sp-menu-item role="menuitem" id="alphabetical" label="zxc" value="${SORT_ORDER.alphabetical}"
